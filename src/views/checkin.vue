      ...
      <el-form :model="form" label-width="100px" :rules="rules" ref="formRef">
        ...
        <el-form-item label="房间号" prop="room">
          <el-select v-model="form.room">
            <el-option label="A区101" value="A区101" />
            <el-option label="A区102" value="A区102" />
            <el-option label="A区103" value="A区103" />
            <el-option label="A区104" value="A区104" />
            <el-option label="A区105" value="A区105" />
            <el-option label="A区106" value="A区106" />
            <el-option label="A区201" value="A区201" />
            <el-option label="A区202" value="A区202" />
            <el-option label="B区101" value="B区101" />
            <el-option label="B区102" value="B区102" />
          </el-select>
        </el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      originalSearchName: '',
      selfCareData: [
        { id: 1, name: '陈国栋', gender: '男', bloodType: 'A', phone: '13912340001', family: '陈小明', idCard: '110101195001011234', building: '606', room: 'A区101', bed: '1床', birthDate: '1950-01-01', checkInTime: '2024-01-01 09:00:00', nursingLevel: '一级', nurse: '李护士', status: '良好' },
        { id: 2, name: '王淑芬', gender: '女', bloodType: 'B', phone: '13912340002', family: '王大力', idCard: '110101195102022345', building: '606', room: 'A区102', bed: '2床', birthDate: '1951-02-02', checkInTime: '2024-01-05 10:30:00', nursingLevel: '一级', nurse: '张护士', status: '良好' },
        { id: 3, name: '刘志远', gender: '男', bloodType: 'O', phone: '13912340003', family: '刘小军', idCard: '110101195203033456', building: '606', room: 'B区101', bed: '1床', birthDate: '1952-03-03', checkInTime: '2024-01-10 14:00:00', nursingLevel: '一级', nurse: '王护士', status: '良好' },
        { id: 4, name: '赵玉兰', gender: '女', bloodType: 'AB', phone: '13912340004', family: '赵国强', idCard: '110101195304044567', building: '606', room: 'B区102', bed: '2床', birthDate: '1953-04-04', checkInTime: '2024-01-15 11:15:00', nursingLevel: '一级', nurse: '李护士', status: '良好' },
        { id: 5, name: '周德明', gender: '男', bloodType: 'A', phone: '13912340005', family: '周建华', idCard: '110101195405055678', building: '606', room: 'A区103', bed: '1床', birthDate: '1954-05-05', checkInTime: '2024-01-20 09:45:00', nursingLevel: '一级', nurse: '张护士', status: '良好' },
        { id: 6, name: '吴桂英', gender: '女', bloodType: 'B', phone: '13912340006', family: '吴志强', idCard: '110101195506066789', building: '606', room: 'C区101', bed: '2床', birthDate: '1955-06-06', checkInTime: '2024-01-25 13:20:00', nursingLevel: '一级', nurse: '王护士', status: '良好' },
        { id: 7, name: '郑文博', gender: '男', bloodType: 'O', phone: '13912340007', family: '郑晓东', idCard: '110101195607077890', building: '606', room: 'A区104', bed: '1床', birthDate: '1956-07-07', checkInTime: '2024-02-01 10:00:00', nursingLevel: '一级', nurse: '李护士', status: '良好' },
        { id: 8, name: '孙丽华', gender: '女', bloodType: 'AB', phone: '13912340008', family: '孙建国', idCard: '110101195708088901', building: '606', room: 'B区103', bed: '2床', birthDate: '1957-08-08', checkInTime: '2024-02-05 14:30:00', nursingLevel: '一级', nurse: '张护士', status: '良好' },
        { id: 9, name: '钱学森', gender: '男', bloodType: 'A', phone: '13912340009', family: '钱小兵', idCard: '110101195809099012', building: '606', room: 'C区102', bed: '1床', birthDate: '1958-09-09', checkInTime: '2024-02-10 09:15:00', nursingLevel: '一级', nurse: '王护士', status: '良好' },
        { id: 10, name: '宋美云', gender: '女', bloodType: 'B', phone: '13912340010', family: '宋大伟', idCard: '110101195910101123', building: '606', room: 'A区105', bed: '2床', birthDate: '1959-10-10', checkInTime: '2024-02-15 11:00:00', nursingLevel: '一级', nurse: '李护士', status: '良好' },
        { id: 11, name: '林凤英', gender: '女', bloodType: 'O', phone: '13912340011', family: '林志远', idCard: '110101196011112234', building: '606', room: 'B区104', bed: '1床', birthDate: '1960-11-11', checkInTime: '2024-02-20 13:45:00', nursingLevel: '一级', nurse: '张护士', status: '良好' },
        { id: 12, name: '郭建华', gender: '男', bloodType: 'AB', phone: '13912340012', family: '郭小明', idCard: '110101196112123345', building: '606', room: 'C区103', bed: '2床', birthDate: '1961-12-12', checkInTime: '2024-02-25 10:30:00', nursingLevel: '一级', nurse: '王护士', status: '良好' },
        { id: 13, name: '唐秀珍', gender: '女', bloodType: 'A', phone: '13912340013', family: '唐国强', idCard: '110101196301013456', building: '606', room: 'A区106', bed: '1床', birthDate: '1963-01-01', checkInTime: '2024-03-01 09:00:00', nursingLevel: '一级', nurse: '李护士', status: '良好' }
      ],
      nursingData: [
